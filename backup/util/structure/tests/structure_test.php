...
class backup_structure_testcase extends advanced_testcase {
    ...
    function test_backup_structure_construct() {
        ...
        $cachepost = count(backup_muc_manager::get_allkeys($backupid, 'forum_post'));
        $cacheuser1 = count(backup_muc_manager::get_allkeys($backupid, 'user1'));
        $cacheuser2 = count(backup_muc_manager::get_allkeys($backupid, 'user2'));
        ...
        $fannotations = backup_muc_manager::get_allkeys($backupid, 'file');
