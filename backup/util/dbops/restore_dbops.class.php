...
abstract class restore_dbops {
     ...
     * @return void
     */
    protected static function set_backup_ids_cached($itemname, $itemid, $extrarecord) {
        $cache = backup_muc_manager::get($itemname);
        ...
        if (!$cache->get($itemid)) {
            ...
            self::update_backup_cached_record($itemid, $itemname, $extrarecord);
        }
    }
     ...
     */
    protected static function update_backup_cached_record($itemid, $itemname, $extrarecord) {
        $cache = backup_muc_manager::get('' . $itemname);
    ...
    */
    ...
    public static function set_backup_ids_record($restoreid, $itemname, $itemid, $newitemid = 0, $parentitemid = null, $info = null) {
        ...
        self::set_backup_ids_cached($itemname, $itemid, $extrarecord);
    }
