...
$string['configgeneralpermissions'] = 'If enabled by default permissions will also be backed up. PLEASE NOTE: Enable this setting will copy the permissions by role. This may give unexpected permissions to users who have the role.';
...
$string['configrestorepermissions'] = 'If enabled by default permissions will be restored if they were included in the backup. PLEASE NOTE: Enable this setting will copy the permissions by role. This may give unexpected permissions to users who have the role.';
